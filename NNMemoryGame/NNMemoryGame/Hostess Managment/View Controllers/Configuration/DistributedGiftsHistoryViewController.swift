...
extension DistributedGiftsHistoryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if (PMIDataSource.defaultDataSource.activeCampaign() == nil) {
            ...
            return PMIDataSource.defaultDataSource.activeCampaign()!.activeTouchpoint!.activeScenario!.distributedGiftScenarios().count
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let giftScenario : GiftScenario = PMIDataSource.defaultDataSource.activeCampaign()!.activeTouchpoint!.activeScenario!.distributedGiftScenarios()[indexPath.row]
